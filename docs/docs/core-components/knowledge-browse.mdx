...
On the **Knowledge** page, click <Icon name="Library" aria-hidden="true"/> **Fetch latest docs** to ingest the latest OpenRAG documentation from docs.openrag.com (this website).
